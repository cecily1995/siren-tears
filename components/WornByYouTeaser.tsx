...
export default function WornByYouTeaser({ items, labels }: { items: Item[]; labels: Labels }) {
  ...
  return (
    <section className="bg-pearl py-28 md:py-36 overflow-hidden">
      <div className="px-6 md:px-12 mx-auto max-w-[1480px] text-center mb-16 reveal">
      ...
      <div className="px-6 md:px-12 mx-auto max-w-[1480px] mt-14 flex flex-col sm:flex-row items-center justify-center gap-8 reveal">
        <Link
          href="/worn-by-you"
