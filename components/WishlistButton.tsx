...
export default function WishlistButton({
  ...
  return (
    <button
      ...
      className={
        className ||
        'absolute top-3 right-3 z-10 w-8 h-8 flex items-center justify-center bg-ivory/85 hover:bg-ivory transition-colors'
      }
    >
      <svg
        width="16"
        ...
        stroke="currentColor"
        strokeWidth="1.5"
        className={saved ? 'text-gold' : 'text-charcoal/70'}
      >
        <path
