...
export default function BespokeTrackSelector({
  ...
  return (
    <>
      ...
      {/* Form reveals once a track is chosen */}
      <section className="bg-pearl px-6 md:px-12 pb-24 md:pb-32">
        <div className="mx-auto max-w-[760px]">
          {!selected ? (
            <p className="text-center text-[0.9rem] text-ash/70 font-light">{labels.chooseHint}</p>
          ) : (
            <>
